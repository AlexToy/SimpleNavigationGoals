...
if("TRUE" STREQUAL "TRUE")
  set(circle_detection_SOURCE_PREFIX /home/alex/catkin_ws/src/circle_detection)
  set(circle_detection_DEVEL_PREFIX /home/alex/catkin_ws/devel)
  ...
  set(circle_detection_INSTALL_PREFIX /home/alex/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'circle_detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alex/catkin_ws/src/circle_detection/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND circle_detection_EXPORTED_TARGETS ${${circle_detection_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "circle_detection-msg-extras.cmake")
